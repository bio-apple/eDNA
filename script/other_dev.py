...
parser.add_argument("--euki","--euki",help="eukaryome ITS",required=True)
parser.add_argument("--euk18s","--euk18s",help="eukaryome 18s",required=True)
...
if args.type=="18s":
    ...
    refs.append(os.path.abspath(args.refseq))
    db_name.append("refseq")
    refs.append(os.path.abspath(args.euk18s))
    db_name.append("eukaryome-18S")
    refs.append(os.path.abspath(args.rfish))
    db_name.append("edna-fish-12S-18S-16S-CO1")
...
if args.type=="ITS":
    ...
    db_name.append("ITS")
    refs.append(os.path.abspath(args.euki))
    db_name.append("eukaryome-ITS")
